...
# Version 1.16.11.6
#       20. add enable_control, disable_control
...
Deputs "----- TAG: $tag -----"
    ...
    method enable_control {} {
		set tag "body Capture::enable_control [info script]"
Deputs "----- TAG: $tag -----"
		if { $handle == "" } { reborn }
		ixNet setA $handle -softwareEnabled True
		ixNet commit
		return [ GetStandardReturnHeader ]
	}
	method disable {} {
...
Deputs "----- TAG: $tag -----"
    ...
    method disable_control {} {
		set tag "body Capture::disable_control [info script]"
Deputs "----- TAG: $tag -----"
		if { $handle == "" } { reborn }
		ixNet setA $handle -softwareEnabled False
		ixNet commit
		return [ GetStandardReturnHeader ]
	}
...
# -field					
#							[header=info] 		frame_size/protocols
